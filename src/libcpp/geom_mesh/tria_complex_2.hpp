    ...
    /*
    --------------------------------------------------------
     * TRIA-COMPLEX-2: piecewise tria. complex in R^2. 
    --------------------------------------------------------
     *
    ...
    #ifndef __TRIA_COMPLEX_2___
    #define __TRIA_COMPLEX_2___
...
/*----------------------------------- tria-complex in R^2 */
    ...
    /*
    --------------------------------------------------------
     * NODE-TRIA: form node-to-tria adj. list.
    --------------------------------------------------------
     */
    ...
    /*
    --------------------------------------------------------
     * EDGE-TRIA: form edge-to-tria adj. list.
    --------------------------------------------------------
     */
