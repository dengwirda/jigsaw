    ...
    /*
    --------------------------------------------------------
     * TRIA-COMPLEX-3: piecewise tria. complex in T^3.
    --------------------------------------------------------
     *
...
#   ifndef __TRIA_COMPLEX_3__
#   define __TRIA_COMPLEX_3__
...
/*----------------------------------- tria-complex in R^3 */
    ...
    indx_type static constexpr topo_dims = +3 ;
    ...
    /*---------------------------------- init. free lists */
        ...
        _ffT3(_asrc),_ffT4(_asrc) ,
    /*---------------------------------- init. work lists */
        _tmp1(_asrc),_tmp2(_asrc),_tmp3(_asrc)
    {
    }

    __inline_call~tria_complex_3 (
        )
    {
