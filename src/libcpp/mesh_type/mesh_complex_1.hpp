    ...
    /*
    --------------------------------------------------------
     * MESH-COMPLEX-1: piecewise mixed complex in T^1.
    --------------------------------------------------------
     *
...
#   ifndef __MESH_COMPLEX_1__
#   define __MESH_COMPLEX_1__

    namespace mesh {

    /*
    --------------------------------------------------------
     * MESH-COMPLEX-1 generic mixed-cell 1-complex.
    --------------------------------------------------------
...
/*----------------------------------- mesh-complex in T^1 */
    ...
    iptr_type static constexpr topo_dims = +1 ;
