...
/*
------------------------------------------------------------
 * LAG-TRI-EUCLIDEAN-3: kernel for 3-dim. laguerre tri.
------------------------------------------------------------
 *
...
#   ifndef __LAGUERRE_TRI_EUCLIDEAN_3__
#   define __LAGUERRE_TRI_EUCLIDEAN_3__

    namespace mesh {

/*
------------------------------------------------------------
 * LAGUERRE-TRI-EUCLIDEAN-3: for lag.-tri. in R^3.
------------------------------------------------------------
 ...
 */
    ...
    typename R
             >
    class laguerre_tri_euclidean_3
    {
/*----------- predicate for laguerre triangulation in R^3 */
    public  :
    typedef R               real_type ;
    typedef I               iptr_type ;
...
#   endif  //__LAGUERRE_TRI_EUCLIDEAN_3__
