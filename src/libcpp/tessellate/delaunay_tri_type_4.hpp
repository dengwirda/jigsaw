...
/*
------------------------------------------------------------
 * DEL-TRI-TYPE-4: 4-dim. delaunay/laguerre tria. types
------------------------------------------------------------
 *
...
#   ifndef __DELAUNAY_TRI_TYPE_4__
#   define __DELAUNAY_TRI_TYPE_4__

    namespace mesh {

/*
------------------------------------------------------------
 * DELAUNAY-TRI-NODE-4: node for delaunay tria. in R^4.
------------------------------------------------------------
 ...
 */
    ...
    typename R
             >
    class delaunay_tri_node_4
    {
/*----------- node-type for delaunay triangulation in R^4 */
    public:
    typedef R                  real_type ;
    typedef I                  iptr_type ;
...
/*
------------------------------------------------------------
 * LAGUERRE-TRI-NODE-4: node for laguerre tria. in R^4.
------------------------------------------------------------
 * IPTR-TYPE - signed-integer typedef.
 * REAL-TYPE - floating-point typedef.
------------------------------------------------------------
 */
    ...
    typename R
             >
    class laguerre_tri_node_4
    {
/*----------- node-type for laguerre triangulation in R^4 */
    public:
    typedef R                  real_type ;
    typedef I                  iptr_type ;
...
/*------------------------------------ local data members */
    containers::
    fixed_array<real_type, +5>    _pval ; // node coord
...
/*
------------------------------------------------------------
 * DELAUNAY-TRI-TRIA-4: tria for delaunay tria. in R^4.
------------------------------------------------------------
 * IPTR-TYPE - signed-integer typedef.
 * REAL-TYPE - floating-point typedef.
------------------------------------------------------------
 */
    ...
    typename R
             >
    class delaunay_tri_tria_4
    {
/*----------- tria-type for delaunay triangulation in R^4 */
    public:
    typedef R                  real_type ;
    typedef I                  iptr_type ;
...
/*------------------------------------ local data members */
    ...
    containers::
    fixed_array<iptr_type, +5>    _fdat ;  // face adjacent

    containers::
    fixed_array<char_type, +5>    _fpos ;  // face adjacent
...
/*---------------------------------------- local indexing */
    __static_call
    __inline_call void_type faceind44 (
        iptr_type *_fnod,
        iptr_type//_fpos
        )
    {
/*-------------------------- return 4-cell local indexing */
        _fnod[0] = 0 ;
        _fnod[1] = 1 ;
        _fnod[2] = 2 ;
        _fnod[3] = 3 ;
...
/*
------------------------------------------------------------
 * LAGUERRE-TRI-TRIA-4: tria for laguerre tria. in R^4.
------------------------------------------------------------
 * IPTR-TYPE - signed-integer typedef.
 * REAL-TYPE - floating-point typedef.
------------------------------------------------------------
 */
    ...
    typename R
             >
    using laguerre_tri_tria_4 = delaunay_tri_tria_4<I, R>;


    }

#   endif//__DELAUNAY_TRI_TYPE_4__
